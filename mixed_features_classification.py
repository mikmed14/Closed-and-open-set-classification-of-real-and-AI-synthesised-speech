...
farid_bona_asv=np.load('faric_features_bona.npy')
farid_a07=np.load('faric_features_a07.npy')
farid_a08=np.load('faric_features_a08.npy')
farid_a09=np.load('faric_features_a09.npy')
farid_a10=np.load('faric_features_a10.npy')
farid_a11=np.load('faric_features_a11.npy')
farid_a12=np.load('faric_features_a12.npy')
farid_a13=np.load('faric_features_a13.npy')
farid_a14=np.load('faric_features_a14.npy')
farid_a15=np.load('faric_features_a15.npy')
farid_a16=np.load('faric_features_a16.npy')
farid_a17=np.load('faric_features_a17.npy')
farid_a18=np.load('faric_features_a18.npy')
farid_a19=np.load('faric_features_a19.npy')

auto_bona=np.load('features_bona.npy')
auto_a07=np.load('features_a07.npy')
auto_a08=np.load('features_a08.npy')
auto_a09=np.load('features_a09.npy')
auto_a10=np.load('features_a10.npy')
auto_a11=np.load('features_a11.npy')
auto_a12=np.load('features_a12.npy')
auto_a13=np.load('features_a13.npy')
auto_a14=np.load('features_a14.npy')
auto_a15=np.load('features_a15.npy')
auto_a16=np.load('features_a16.npy')
auto_a17=np.load('features_a17.npy')
auto_a18=np.load('features_a18.npy')
auto_a19=np.load('features_a19.npy')

features_bona=np.concatenate((farid_bona_asv, auto_bona), axis=1)
features_a07=np.concatenate((farid_a07, auto_a07), axis=1)
features_a08=np.concatenate((farid_a08, auto_a08), axis=1)
features_a09=np.concatenate((farid_a09, auto_a09), axis=1)
features_a10=np.concatenate((farid_a10, auto_a10), axis=1)
features_a11=np.concatenate((farid_a11, auto_a11), axis=1)
features_a12=np.concatenate((farid_a12, auto_a12), axis=1)
features_a13=np.concatenate((farid_a13, auto_a13), axis=1)
features_a14=np.concatenate((farid_a14, auto_a14), axis=1)
features_a15=np.concatenate((farid_a15, auto_a15), axis=1)
features_a16=np.concatenate((farid_a16, auto_a16), axis=1)
features_a17=np.concatenate((farid_a17, auto_a17), axis=1)
features_a18=np.concatenate((farid_a18, auto_a18), axis=1)
features_a19=np.concatenate((farid_a19, auto_a19), axis=1)
...
plt.savefig('cm_mixed_multi_svm.png')
...
plt.savefig('cm_mixed_multi_logovr.png')
...
plt.savefig('cm_mixed_multi_forest.png')
...
plt.savefig('cm_mixed_bvs_svm.png')
...
plt.title('Confusion matrix, binary classification bonafide vs fake,'
          ' Logistic regression')
plt.savefig('cm_mixed_bvs_logovr.png')
...
plt.title('Confusion matrix, binary classification bonafide vs fake,'
          ' Random forest')
plt.savefig('cm_mixed_bvs_forest.png')
...
plt.title('Confusion matrix, binary classification bonafide vs a19,'
          ' SVM')
plt.savefig('cm_mixed_a19_svm.png')
...
plt.savefig('cm_mixed_oneclass_bona.png')
...
plt.ylabel('True label')
plt.xlabel('Predicted label')
plt.title('Confusion matrix, Open set with bonafide as known'
          )
plt.savefig('cm_mixed_openset_btrain.png')
...
np.save('ORO_mixed_features.npy', ORO_features)
np.save('ORO_mixed_labels.npy', test_labels)
...
plt.savefig('roc_mixed_max_btrain.png')
...
plt.ylabel('True Positive Rate')
plt.xlabel('False Positive Rate')
plt.savefig('roc_mixed_ratio_btrain.png')
...
plt.ylabel('True label')
plt.xlabel('Predicted label')
plt.title('Confusion matrix, Open set with bonafide as unknown'
          )
plt.savefig('cm_mixed_openset_strain.png')
...
plt.ylabel('True Positive Rate')
plt.xlabel('False Positive Rate')
plt.savefig('roc_mixed_max_strain.png')
...
plt.ylabel('True Positive Rate')
plt.xlabel('False Positive Rate')
plt.savefig('roc_mixed_ratio_strain.png')
...
scatter09=plt.scatter(reduced_a09[:, 0],reduced_a09[:, 1], c='tab:green', alpha=0.5 )
scatter11=plt.scatter(reduced_a11[:, 0],reduced_a11[:, 1], c='tab:orange', alpha=0.5 )
scatter14=plt.scatter(reduced_a14[:, 0],reduced_a14[:, 1], c='#000000', alpha=0.5 )
scatter17=plt.scatter(reduced_a17[:, 0],reduced_a17[:, 1], c='#ff0000', alpha=0.5 )
...
plt.savefig('scatter_mixed_ica_2.png')
...
plt.savefig('scatter_mixed_ica_3d_3.png')
...
ORO_features=np.load('ORO_mixed_features.npy')
ORO_labels=np.load('ORO_mixed_labels.npy')
...
plt.ylabel('True label')
plt.xlabel('Predicted label')
plt.savefig('cm_mixed_ORO_bs.png')
...
plt.ylabel('True label')
plt.xlabel('Predicted label')
plt.savefig('cm_mixed_ORO_ku.png')
...
scatter_spoof_0=ax.scatter(test_features0_spoof_array[:,0], test_features0_spoof_array[:,1], test_features0_spoof_array[:,2], c='#ffff00')
...
scatter_spoof_1=ax.scatter(test_features1_spoof_array[:,0], test_features1_spoof_array[:,1], test_features1_spoof_array[:,2], c='#ff0000')
...
plt.title('Scatter plot, K-Means Clustering')
plt.savefig('scatter_oro_mixed.png')
...
# OPEN SET with known-unknown features in the training
# and bonafide as unknown

# a09 a11 a13 a14 a17, (a07, a08, a10)
...
plt.savefig('cm_mixed_open_strain_ku2.png')
...
plt.xlabel('Predicted label')
plt.title('Confusion matrix, Open set classification with known/unknown features and bonafide as unknown')
plt.savefig('cm_mixed_open_strain_ku1.png')
...
plt.ylabel('True Positive Rate')
plt.xlabel('False Positive Rate')
plt.savefig('roc_mixed_strain_confronto_final_2.png')
...
plt.figure()
plt.plot(false_pos_rate07_ratio, true_pos_rate07_ratio, linewidth=5,
         label='AUC = %0.3f' % roc_auc07_ratio)
plt.plot([0, 1], [0, 1], linewidth=5)
plt.xlim([-0.01, 1])
plt.ylim([0, 1.01])
plt.legend(loc='lower right')
...
plt.savefig('cm_mixed_open_btrain_ku2.png')
...
plt.xlabel('Predicted label')
plt.title('Confusion matrix, Open set classification with known/unknown features and bonafide as known')
plt.savefig('cm_mixed_open_btrain_ku1.png')
...
plt.legend(loc='lower right')
plt.scatter(c2,c1,c='#ff5733' )
#plt.title('ROC curve, maximum score and score ratio, bonafide as unknown')
plt.ylabel('True Positive Rate')
plt.xlabel('False Positive Rate')
plt.savefig('roc_mixed_btrain_confronto_final_2.png')
